...
const Level4 = {
   ...
   questions: [
    { q: "What does CPU stand for?", options: ["Central Processing Unit", "Core Processing Utility", "Computer Power Unit", "Central Program Uploader"], correct: 0 },
    { q: "What do you use to browse the internet?", options: ["Terminal", "Web Browser", "Notepad", "Compiler"], correct: 1 },
    { q: "Which company made the iPhone?", options: ["Samsung", "Google", "Apple", "Microsoft"], correct: 2 },
    { q: "What does RAM stand for?", options: ["Run Any Module", "Read All Memory", "Random Allocated Machine", "Random Access Memory"], correct: 3 },
    ...
    { q: "Which of these is a social media platform?", options: ["Instagram", "Java", "Linux", "Python"], correct: 0 },
    { q: "What does an SSD store?", options: ["Power", "Data and files", "Internet connection", "Sound"], correct: 1 },
    { q: "What does PDF stand for?", options: ["Personal Doc Folder", "Printed Data File", "Portable Document Format", "Program Data Form"], correct: 2 },
    ...
    { q: "What does a webcam do?", options: ["Stores files", "Connects to Wi-Fi", "Prints documents", "Captures video"], correct: 3 },
    { q: "What does GPS stand for?", options: ["Global Positioning System", "Graphical Position Setup", "General Power Supply", "Global Program Software"], correct: 0 },
    { q: "Which of these stores data permanently?", options: ["CPU", "Hard Drive", "Monitor", "RAM"], correct: 1 },
    { q: "What does HTML stand for?", options: ["Home Tool Markup Language", "High Tech Modern Language", "Hyper Text Markup Language", "Hyperlinks Text Mark Language"], correct: 2 },
    ...
    { q: "Which of these is a mobile operating system?", options: ["Android", "macOS", "Linux Ubuntu", "Windows XP"], correct: 0 },
    { q: "What does Bluetooth do?", options: ["Cools computers", "Short range wireless data transfer", "Charges devices", "Provides internet"], correct: 1 },
    { q: "Which of these is a cloud storage service?", options: ["Notepad", "Photoshop", "Google Drive", "Calculator"], correct: 2 },
    { q: "What is the function of a monitor?", options: ["Store files", "Process data", "Input commands", "Display visual output"], correct: 3 },
    { q: "Which key is used to delete text to the left?", options: ["Backspace", "Tab", "Delete", "Enter"], correct: 0 },
    { q: "What does a router do?", options: ["Stores data", "Connects devices to the internet", "Prints documents", "Displays images"], correct: 1 },
    { q: "What does www stand for?", options: ["World Web Wide", "Web World Wide", "World Wide Web", "Wide World Web"], correct: 2 },
    { q: "Which of these is an antivirus software?", options: ["Chrome", "Zoom", "Excel", "Norton"], correct: 3 },
    ...
    { q: "What does ctrl+V do?", options: ["Copy", "Cut", "Paste", "Close"], correct: 2 },
    { q: "Which company created Facebook?", options: ["Google", "Microsoft", "Apple", "Meta"], correct: 3 },
    { q: "What is a gigabyte?", options: ["A unit of data storage", "A type of virus", "An internet speed", "A programming language"], correct: 0 },
    { q: "What does a power supply unit do?", options: ["Stores data", "Supplies power to the computer", "Displays images", "Connects to internet"], correct: 1 },
    { q: "Which of these is a video conferencing app?", options: ["Word", "Excel", "Zoom", "Paint"], correct: 2 },
    { q: "What is a tablet?", options: ["A type of medicine", "A keyboard", "A printer", "A portable touchscreen computer"], correct: 3 },
    { q: "What does HDMI stand for?", options: ["High Definition Multimedia Interface", "Hard Drive Media Installation", "Heavy Duty Media Input", "High Data Memory Interface"], correct: 0 },
    { q: "Which of these is a file extension for images?", options: [".mp3", ".jpg", ".txt", ".exe"], correct: 1 },
    ...
    { q: "What does a refresh button do?", options: ["Closes the window", "Turns off computer", "Opens a new tab", "Reloads the current page"], correct: 3 },
    { q: "Which of these is a valid file name?", options: ["myfile.txt", "my:file.txt", "my file?.txt", "my/file.txt"], correct: 0 },
    { q: "What is the home button on a browser for?", options: ["Closes browser", "Goes to homepage", "Opens settings", "Refreshes page"], correct: 1 },
    { q: "Which company makes the PlayStation?", options: ["Sega", "Nintendo", "Sony", "Microsoft"], correct: 2 },
    { q: "What does double-clicking usually do?", options: ["Deletes item", "Selects item", "Copies item", "Opens item"], correct: 3 }
],
